 ...
 */
_.merge(clientBuilder.routeConfig, {
    list: {
        template  : '<apt-panel><apt-client-list data-view-type="media" data-edit-conf="editConf" data-add-new-conf="addNewConf"/></apt-panel>',
