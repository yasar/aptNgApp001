...
OR (card_type.`name` = 'promotion') AND (t.name='everyone' OR cg.client_id=" . CouponInspector::$postData['client_id'] . ") ";
     ...
     */
    private static function importPaymentSplits(array $postData)
    {
     ...
     */
    private static function loadFilteredCoupons(array $coupon_ids)
    {
...
//            /* @var $coupon CouponObject */
        foreach (CouponInspector::$filteredCoupons as $key => $coupon) {
            $is_analyzed = false;
