...
//		}
//
//		$couponTarget = $this->getRecordObject();
//		$couponTarget->load();
//
//
...
//		$couponTargetGroupPost                                    = ['coupon_target_id' => $couponTarget->coupon_target_id,];
//		$couponTargetGroup->getRecordObject()
//		                  ->loadFromArray($couponTargetGroupPost);
//		$couponTargetGroup->getRecordObject()
//		                  ->add();
//
//		//		return $couponTarget;
